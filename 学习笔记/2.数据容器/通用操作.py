...
print(f"字典 转列表的结果是：{list(my_dict)}")    #只保留key
...
print()
# 容器转字符串
print(f"列表 转字符串的结果是：{str(my_list)}")    # "[1, 2, 3, 4, 5]"
print(f"元组 转字符串的结果是：{str(my_tuple)}")   # "(1, 2, 3, 4, 5)"
...
print(f"字符串转集合的结果是：{set(my_str)}")      # 无序，去重
print(f"集合 转集合的结果是：{set(my_set)}")
print(f"字典 转集合的结果是：{set(my_dict)}")     # 只保留key
